...
const Docs = () => {
  ...
  "name": "Support WhatsApp" // Optional custom name
              ...
              <div className="alert-box warning-alert" style={{ marginTop: '40px' }}>
                <p>
                  <strong>⚠️ Expiration Note:</strong> The QR code will expire in <code>validinsecond</code> (40s). You will need to call the <strong>Initiate API</strong> again with your <code>instanceKey</code> to receive a fresh QR code as shown below.
                </p>
              </div>
