...
const messageController = {
    sendBulkMessage: async (req, res) => {
        try {
            ...
            res.json({ success: true, message: 'Bulk messages queued', queuedCount: messages.length });
    ...
    getReports: async (req, res) => {
        try {
            ...
            const reports = await MessageLog.findAll({
                where: { 
                ...
                group: [
                    ...
                    'instanceId',
                    'instance.id' // Required for PostgreSQL and some other DBs when grouping with joined table
                ],
